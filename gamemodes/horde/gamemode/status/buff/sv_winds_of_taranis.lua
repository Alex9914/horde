...
function plyMeta:Horde_AddWindsOfTaranis( duration )
    ...
    if self.Horde_WindsOfTaranis then return end
    self.Horde_WindsOfTaranis = true
...
function plyMeta:Horde_RemoveWindsOfTaranis()
    ...
    if not self.Horde_WindsOfTaranis then return end
    self.Horde_WindsOfTaranis = false
...
hook.Add( "Horde_ResetStatus", "Horde_WindsOfTaranisReset", function( ply )
    ply.Horde_WindsOfTaranis = false
end )